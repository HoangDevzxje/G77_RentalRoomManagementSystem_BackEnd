 ...
 *   delete:
 *     summary: Xóa tầng
 *     description: Xóa một tầng nếu không có phòng liên quan (chỉ admin hoặc landlord sở hữu tòa nhà, yêu cầu subscription active).
 *     tags: [Floor]
 *     security:
 *       - BearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Tầng được xóa thành công
 *         content:
 *           application/json:
 *             schema:
 *               type: object
