...
const ratingRoute = require("././Landlord/ratingRoute");
const residentRoute = require("././Landlord/residentRoute");
...
const dashboardRouteLandlord = require("././Landlord/dashboardRoutes");
...
const routes = (app) => {
  ...
  app.use("/landlords/dashboard", dashboardRouteLandlord);
  ...
  app.use("/invoices", tenantInvoiceRoute);
